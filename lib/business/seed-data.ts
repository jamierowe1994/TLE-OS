...
import type { FunnelStats, StatValue } from "@/lib/business/types";
import type {
  AgentKpiRow,
  ArrearsAgingBucket,
  ArrearsTenantRow,
...
import {
  ...
  agentKeysForName,
  nameMatchesAgent,
} from "@/lib/business/roster";

// Re-export the client-safe pieces so existing server-side imports
// (`import { ROSTER } from "@/lib/business/seed-data"`) keep working.
export {
  ROSTER,
  SNAPSHOT_DATE,
  SNAPSHOT_NOTE,
