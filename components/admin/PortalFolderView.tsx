...
import type { PortalFolder } from "@/lib/portals";
...
export default function PortalFolderView({ f, backHref = "/admin/process", backLabel = "← All processes" }: { f: PortalFolder; backHref?: string; backLabel?: string }) {
  ...
  return (
    <>
      ...
      <p className="fade-up mt-4">
        <Link href={backHref} className="text-[11.5px] text-muted underline hover:text-ink">
          {backLabel}
        </Link>
      </p>
