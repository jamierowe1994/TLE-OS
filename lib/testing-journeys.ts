...
export const JOURNEYS: Journey[] = [
  {
    ...
    steps: [
      ...
      {
        id: "landlord-docs",
        title: "Landlord portal: offers and upkeep",
        what: "The landlord sees offers on their property and maintenance.",
        how: [],
        state: "notbuilt",
        todo: "Offers from Applications; upkeep from REX PM once there is a source.",
        since: "2026-09-02",
      },
      {
        id: "stage-moves",
