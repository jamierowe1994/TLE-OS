...
export default function FileSearch() {
  ...
  return (
    <label className="flex min-w-0 flex-1 items-center gap-2.5 rounded-full border border-line/70 bg-box px-4 py-2 text-[12.5px] transition-colors focus-within:border-ink/40">
