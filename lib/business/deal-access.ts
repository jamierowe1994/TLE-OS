...
import { verifySessionToken, SESSION_COOKIE, isAdminEmail } from "@/lib/business/auth";
import { isPreTenancyEmail } from "@/lib/business/brand";
import { findById, type StoredUser } from "@/lib/business/users-store";
import {
  dealBelongsToUser,
  getAllPropolyDeals,
  type BusinessDeal,
