...
import { MAINTENANCE_PROCESS } from "@/lib/process/maintenance";
...
const DEFAULTS: Record<string, ProcessMap> = { tenant: TENANT_PROCESS, landlord: LANDLORD_PROCESS, maintenance: MAINTENANCE_PROCESS };
