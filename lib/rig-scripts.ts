...
const AGENT: RigStep[] = [
  {
    ...
    see: "The property, the tenants and the move-in date arrive already filled in from the application. You typed none of it.",
    why: "If any of this is ever blank or wrong on a real application, press Something is not right and fix it on the application. Everything downstream is built on it.",
    side: "agent",
  },
  {
    id: "warnings",
    title: "Read the warnings",
    act: "Look under the details for anything flagged in orange.",
    see: "A warning that Right to Rent is not recorded for every adult applicant.",
    why: "These are the gaps the application already knows about. They are cheaper to fix now than after compliance send the pack back.",
    side: "agent",
  },
  {
    id: "details",
    title: "Check the move-in date",
    act: "Check the move-in date, then press Continue.",
    see: "The landlord's documents come next, and the move-in date you confirmed is the one shown again on the last screen.",
    why: "Every date check compliance run is 'in date ON the move-in date'. A wrong move-in date makes every answer wrong and nothing on the screen will look broken.",
    side: "agent",
  },
  {
    id: "attach",
    title: "Attach the pack",
    act: "Attach a document against a check, leave one deliberately empty, and press Next until you reach the last screen.",
    see: "The check you filled turns green. Next still lets you move on, but the last screen shows the empty one as missing, and Send to the compliance team stays grey until every check has a file or a Not needed reason.",
    why: "Nothing leaves you short. A pack that reaches the check without a document fails it, and a failed check is charged again, so the gap is caught on your screen rather than theirs.",
    side: "agent",
  },
  {
    id: "note",
    title: "Tell compliance what they need to know",
    act: "On the last screen, write something in Anything compliance should know.",
    see: "Your words stay in the box. It is optional, and it goes with the pack exactly as you wrote it.",
    why: "It is the one place to say what the files cannot. Anything you do not write here, Kirstie has to come and ask you for, and that is a day.",
    side: "agent",
  },
  {
    id: "submit",
    title: "Hand it over",
    act: "Attach a file or write a Not needed reason for anything still empty, then press Send to the compliance team.",
    see: "That Is With the Compliance Team, and the pack is no longer yours to edit. The 48 hours starts now.",
    why: "Sending LOCKS the pack. That is on purpose, so that what compliance read is what you sent.",
    side: "agent",
  },
  {
    id: "other-side",
    title: "See where it went",
    act: "Look at your pack as compliance see it.",
    see: "The pack you just sent, with your note and the files you attached.",
    why: "Worth seeing once. Most of what makes a pack slow is invisible from your side until you have looked at it from theirs.",
    side: "compliance",
  },
  {
    id: "defer",
    title: "Send it back, as compliance",
    act: "Press Skip it, I will read them. Then write a reason and press Defer.",
    see: "Deferred, with the time and the reason you wrote.",
    why: "Whatever is written here is all the agent sees, so it is worth knowing what a good one looks like.",
    side: "compliance",
  },
  {
    id: "deferred",
    title: "What coming back looks like",
    act: "Wait for the opening panel, read what compliance wrote, then press Reopen and fix it.",
    see: "Compliance Sent This Back, with the reason exactly as written. Reopen and fix it takes you to the last screen, with the reason still showing and the pack yours to change again.",
    why: "A deferral is not an ending. It is the check working. Knowing what it looks like means you fix it rather than ring somebody about it.",
    side: "agent",
  },
];
