...
export const FONT_STACKS = [
  ...
  { key: 'sacramento', label: 'Sacramento (handwritten)', web: true,
    stack: "Sacramento, 'Snell Roundhand', 'Apple Chancery', 'Segoe Script', cursive" },
...
const WEBFONT_LINK =
  '<link href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400..700;1,400..700&family=Montserrat:wght@300..800&family=Sacramento&display=swap" rel="stylesheet" />';
